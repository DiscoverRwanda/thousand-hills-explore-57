...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md py-2' : 'bg-white py-4'}`}>
      ...
      {/* Secondary Navigation - updated to match footer colors */}
      ...
      {/* Mobile menu - updated with new colors for secondary links */}
      {isOpen && (
        <div className="lg:hidden bg-white">
          <div className="px-4 pt-2 pb-4 space-y-1">
            ...
            {/* Secondary Mobile Menu - updated to match footer styling */}
